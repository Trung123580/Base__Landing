...
//           <h1>
//             <Link href={'/'}>
//               <Image className="object-contain aspect-[100/100]" src={'/assets/header/logo.png'} width={100} height={100} alt={''}/>
//             </Link>
//           </h1>
//           <div className="flex">
//             {isAuthenticated ? <Button onClick={() => handleLogout({key: ['token']})}> 
//               <Image className="object-contain aspect-[233/66]" src={'/assets/header/btn-logout.png'} width={233} height={66} alt={''}/>
//             </Button> : <Button onClick={() => handleLogin({redirectUrl: process.env.NEXT_PUBLIC_REDIRECT_URL as string})}>
//               <Image className="object-contain aspect-[233/66]" src="/assets/header/btn-login.png" width={233} height={66} alt={''}/>
//             </Button>}
//             <a className="inline-block" onClick={(e) => handleClickLink(e, linkDowLoad())} href={linkDowLoad() ?? '#'} target="_blank">
//               <Image className="object-contain aspect-[233/66]" src={'/assets/header/btn-download.png'} width={233} height={66} alt={''}/>
//             </a>
//           </div>
...
//           <Link onClick={(e) => handleClickLink(e, undefined)} href={'/'}>Trang chủ</Link>
